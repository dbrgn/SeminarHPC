...
Wird der Prozess sp"ater auf eine andere CPU migriert, kann er pl"otzlich
...
\rhead{Konsequenzen f"ur das Programm-Design}
...
\index{Datenlokalitat@Datenlokalit\"at}
