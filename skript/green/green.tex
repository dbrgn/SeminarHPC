...
gut als Linien von Spitzen sichtbar sind (\fref{fig:201_1}).
...
\fref{fig:dreiSchritte} stellen drei solche Schritte dar, wie wir
...
Ansicht, d.h ein 3D-Plot wie er z.B. in \fref{fig:201_1} zusehen
...
\fref{sec:geeignetesF} erw"ahnt, hat sich eine Spirale von Punkten
