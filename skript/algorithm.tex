...
\subsection{Jacobi-Algorithmus\label{section-jacobi}}
\index{Algorithmus!Jacobi}
...
\index{Algorithmus!Gauss-Seidel}
...
Nat"urlich kann man sich f"ur spezielle Anwendungen
...
\begin{satz}
\index{Iterationsverfahren!Auf einer Matrixzerlegung basierendes}
...
\index{CG-Algorithmus}
\index{Algorithmus!der konjugierten Gradienten}
