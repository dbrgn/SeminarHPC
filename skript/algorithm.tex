...
\subsubsection{Geometrische Beschreibung des CG-Algorithmus}
...
$\langle r_1,\dots,r_{r+1}$, damit ist die zweite Inklusion in
...
\begin{proof}[Beweis]
Der Vektor $v_{i+1}$ entsteht aus $r_{i+}$ durch Orthogonalisierung.
\end{proof}
}
