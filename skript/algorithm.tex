...
f"ur gen"ugen grosse $k$ durch einen Phasenfaktor $e^{i\varphi}$.
Es ist nat"urlich $\lambda_1 = |\lambda_1|e^{i\varphi}$.
Ausser $v_1$ ist nat"urlich auch jeder Vektor $e^{i\varphi}v_1$ ein
...
$\arg z=\varphi$, dass $z=|z|e^{i\varphi}$.
