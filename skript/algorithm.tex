...
Eine gute Beschreibung findet man auch im Buch von Watkins \cite{skript:watkins}.
...
l&\leftarrow r^tr  &&\text{L"ange von $r$}
\end{align*}
...
3.&&\alpha&\leftarrow l/\mu         &&\text{Koeffizient f"ur Abstiegsschritt}\\
4.&&     x&\leftarrow x-\alpha v    &&\text{Update N"aherungsl"osung}\\
5.&&     r&\leftarrow r-\alpha q    &&\text{Update Gradient}\\
6.&&   l_2&\leftarrow r^tr          &&\text{L"ange von $r$}\\
7.&&     v&\leftarrow r - (l_2/l) v &&\text{Orthogonalisierung von $r$ ergibt
                                            Abstiegsrichtung}\\
8.&&     l&\leftarrow l_2           &&
\end{align*}
...
Details dazu in \cite{skript:watkins}.
