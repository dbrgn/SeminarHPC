...
Obwohl OpenCL gemacht ist für sehr grosse Probleme, st''osst es irgendwann an 
seine Grenzen. Was diese Grenzen sind, wie man herausfindet wo diese bei der
eingesetzten Hardware liegen und wie man das Problem so aufteilen kann, dass
es trotzdem gerechnet werden kann.

\subsection{(Hardware-)grenzen mit OpenCL}
