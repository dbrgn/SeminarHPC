...
m"oglichst gleichverteilt auftreten. In der Kryptologie wird zwischen schwacher
und starker Kollisionsresistenz
...
Passw"orter vorberechnet (wie wir es in dieser Arbeit tun), m"ochte man eine
Funktion welche aufw"andig und ressourcenintensiv zu berechnen ist.
