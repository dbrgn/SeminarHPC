...
Kapitel \ref{crypto:kollisionsresistenz}) und sollte f"ur kryptologische
...
Hashwert nicht frei gew"ahlt werden kann, sondern festgelegt ist (ein Angriff
auf die schwache Kollisionsresistenz). Wenn man nun einen Passwort-Hash
zur"uckrechnen will, ist daher bei einer "uberschaubaren Eingabemenge ein
Brute-Force Angriff die simpelste M"oglichkeit.
...
% @ Danilo: Ich w"urde es drin lassen. Sind zwei kurze Abschnitte, die fressen kaum
% Heu, aber ein bisschen Hintergrundinfo, denke ich kann nicht schaden.
% TODO: Ich w"urde auf Erweiterungen gar nicht erst eingehen. Sie sind f"ur uns ja
...
% TODO: Hier ebenfalls, ich w"urde OpenGL gar nicht erst erw"ahnen, sondern ganz
...
werden, wie man die maximal m"ogliche Gr"osse eines Problems f"ur die
spezifische Hardware errechnen kann, die gleichzeitig der Hardware "ubergeben
werden kann.
...
Kapitel sehen werden, einen grossen Einfluss auf die gesamte Rechenzeit haben
kann.
...
% TODO Lukas: Codebeispiel f"ur Globale OpenCL Variable
...
Eingabewerte eine arithmetische Folge darstellt. Es liegt also nahe, das Wort aus der
...
Jahr 2001 von Alexander Peslyak geschrieben und dann als gemeinfrei
ver"offentlich wurde.
...
Python-Kenntnisse n"otig sind). Auf die Syntax von Python und die
Implementations-Details der Library wird hier nicht n"aher eingegangen.
