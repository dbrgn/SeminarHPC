 ...
 *                      [6]: number of attracting points
 *                      [7]: attracting point[0] real part
 *                      [8]: attricting point[1] imaginary part
...
__kernel void	iterate(__global double *parameters, __global int *output) {
	...
	// now perform forward iteration for 100 steps
	__private int	i;
	for (i = 0; i < 100; i++) {
